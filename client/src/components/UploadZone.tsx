    ...
    <div className="relative group">
      <div
        className={`relative h-64 rounded-2xl border-2 border-dashed
             transition-all duration-300 flex flex-col items-center justify-center bg-white/2 p-6 ${
               file
        ...
        {file ? (
          <>
            <img
              ...
              alt="preview"
              className="
                    absolute inset-0 w-full h-full object-cover rounded-xl opscity-60"
            />
            <div
            ...
            >
              <button
                ...
                onClick={onClear}
                className="p-2
                        rounder-full bg-white/10 hover:bg-red-500/20 text-white 
            ...
            <div
              className="absolute bottom-4  left-4 right-4 bg-black/50 
          ...
          <>
            <div
              className="w-16 h-16 rounded-full bg-white/5 flex items-center 
